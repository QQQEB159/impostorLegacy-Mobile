...
class Controls extends FlxActionSet
{
	...
	inline function get_NOTE_TAUNT() return _note_taunt.check() || MusicBeatState.getState().mobileControls.buttonExtra.pressed;
	
	public var NOTE_TAUNT_P(get, never):Bool;
	
	inline function get_NOTE_TAUNT_P() return _note_tauntP.check() || MusicBeatState.getState().mobileControls.buttonExtra.justPressed;
	
	public var NOTE_TAUNT_R(get, never):Bool;
	
	inline function get_NOTE_TAUNT_R() return _note_tauntR.check() || MusicBeatState.getState().mobileControls.buttonExtra.justReleased;
